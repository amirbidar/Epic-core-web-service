...
import ir.it.orbit.web.rest.errors.ExceptionTranslator;
...
public class BookResourceITest {
    ...
    public void testEntityFromId() {
        Assertions.assertThat(bookMapper.fromId(42L).getId()).isEqualTo(42);
        Assertions.assertThat(bookMapper.fromId(null)).isNull();
    }
}
